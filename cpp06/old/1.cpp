...
// You have to handle these pseudo literals as
//  well (you know, for science): -inff, +inff
// and nanf.
// Examples of double literals: 0.0, -4.2, 4.2...
// You have to handle these pseudo literals as well
//  (you know, for fun): -inf, +inf and nan.

// You have to first detect the type of the
//  literal passed as parameter, convert it from
// string to its actual type, then convert it explicitly
//  to the three other data types. Lastly,
